...
<div class="container mt-2 mb-5" style="max-width: 700px;">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0" style="color: #1e293b;">Master Data &rsaquo; Tambah Lokasi</h4>
    </div>
        ...
        <form method="POST" action="{{ route('lokasi.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_lokasi" id="nama_lokasi" 
                       ...
                       placeholder="Masukkan nama lokasi (contoh: Gudang A, Rak B...)" required autofocus>
                @error('nama_lokasi')
            ...
            <div class="mb-5">
                ...
                <textarea name="deskripsi" id="deskripsi"
                          ...
                          rows="4"
                          placeholder="Tambahkan penjelasan singkat mengenai lokasi ini...">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <div class="invalid-feedback fw-medium mt-1">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                ...
                <button type="submit" class="btn btn-orange px-5 fw-bold"><i class="fa-solid fa-save me-1"></i> Simpan Lokasi</button>
            </div>
        </form>
    </div>
</div>
