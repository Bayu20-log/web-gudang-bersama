...
<div class="container-laporan mb-5">     
    ...
    <div class="d-flex flex-wrap gap-2 mb-4">         
        <a href="{{ route('export.omzet.pdf', request()->query()) }}" target="_blank" class="btn btn-danger fw-bold shadow-sm">             
            <i class="fa-solid fa-file-pdf me-1"></i> PDF         
        </a>         
        <a href="{{ route('export.omzet.excel', request()->query()) }}" class="btn btn-success fw-bold shadow-sm">             
