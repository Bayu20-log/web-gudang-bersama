...
<style>
    ...
    .preview-box { width: 100%; height: 150px; border: 2px dashed #cbd5e1; border-radius: 8px; display: flex; align-items: center; justify-content: center; background-color: #f8fafc; overflow: hidden; margin-top: 10px; }
    .preview-box img { max-width: 100%; max-height: 100%; object-fit: contain; }
    .form-label { font-weight: 500; color: #4b5563; }
    .select2-container--bootstrap-5 .select2-selection { background-color: #f8fafc; border: 1px solid #dee2e6; padding: 0.375rem 0.75rem; min-height: 38px; }
</style>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_barang" id="nama_barang" class="form-control bg-light" value="{{ old('nama_barang') }}" placeholder="Masukkan nama produk" required>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" id="deskripsi" class="form-control bg-light" rows="5" placeholder="Tambahkan catatan khusus untuk produk ini...">{{ old('deskripsi') }}</textarea>
                </div>
            </div>
        </div>

        <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
            <!-- Jika datang dari Barang Masuk, Batal akan mengarah ke Barang Masuk -->
            <a href="{{ request('redirect') == 'barang-masuk' ? route('barang-masuk.create') : route('item.index') }}" class="btn btn-outline-secondary px-4 fw-medium">Batal</a>
            <button type="submit" class="btn btn-orange px-5 fw-bold"><i class="bi bi-save me-2"></i>Simpan Produk</button>
        </div>
    </form>
</div>
