    ...
    <div class="table-wrapper">
        <table>
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-action">
                            <div class="d-flex flex-wrap gap-2 justify-content-center">
                                <a href="{{ route('satuan.edit', $satuan->id) }}" class="btn-action text-dark shadow-sm" style="background-color: #facc15;">
                                    <i class="fa-solid fa-pen-to-square"></i> Edit
                                </a>
                                <form id="delete-form-{{ $satuan->id }}" action="{{ route('satuan.destroy', $satuan->id) }}" method="POST" style="margin: 0;">
                                    @csrf @method('DELETE')
                                    <button type="button" class="btn-action text-white shadow-sm" style="background-color: #ef4444;" onclick="confirmDelete('{{ $satuan->id }}')">
                ...
                @empty
                    <tr><td colspan="5" class="text-center py-5 text-muted fw-medium"><i class="fa-solid fa-folder-open fs-2 mb-2 d-block text-light"></i>Data satuan belum tersedia.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
