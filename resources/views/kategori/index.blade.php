...
<div class="container-laporan">
    ...
    <form method="GET" action="{{ route('kategori.index') }}" class="filter-form">
        <div class="form-group">
            ...
            <input type="text" name="search" id="search" placeholder="Cari nama kategori, deskripsi" value="{{ request('search') }}">
        </div>
        <button type="submit">Filter</button>
        <a href="{{ route('kategori.index') }}" class="back-button">Reset</a>
    </form>
            ...
            <tbody>
                @forelse($kategoris as $index => $kategori)
                    <tr>
                        ...
                        <td>{{ optional($kategori->created_at)->format('d-m-Y H:i:s') }}</td>
                        <td>{{ optional($kategori->updated_at)->format('d-m-Y H:i:s') }}</td>
                        <td>
                            <div class="action-buttons">
                                <a href="{{ route('kategori.edit', $kategori->id) }}" class="btn-action btn-edit">Edit</a>
