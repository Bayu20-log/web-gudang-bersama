        ...
        <form method="POST" action="{{ route('pemasok.store') }}">
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="nama_pic" class="form-control @error('nama_pic') is-invalid @enderror" value="{{ old('nama_pic') }}" placeholder="Nama penanggung jawab" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="no_telepon" class="form-control @error('no_telepon') is-invalid @enderror" value="{{ old('no_telepon') }}" placeholder="08xxxxxxxx">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="jenis" class="form-control @error('jenis') is-invalid @enderror" value="{{ old('jenis') }}" placeholder="Contoh: Distributor, Pabrik...">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="bergabung_sejak" class="form-control @error('bergabung_sejak') is-invalid @enderror" value="{{ old('bergabung_sejak') }}">
                ...
                <div class="col-12">
                    ...
                    <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="3" placeholder="Alamat lengkap perusahaan...">{{ old('alamat') }}</textarea>
            ...
            <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                ...
                <button type="submit" class="btn btn-orange px-5 fw-bold"><i class="fa-solid fa-save me-1"></i> Simpan Pemasok</button>
            </div>
        </form>
    </div>
</div>
