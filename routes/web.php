...
Route::get('/profil', function () { return view('landingpage.profil'); })->name('profil');
Route::get('/fitur/gudang', function () { return view('landingpage.gudang'); })->name('gudang');
Route::get('/fitur/superadmin', function () { return view('landingpage.superadmin'); })->name('superadmin');
Route::get('/fitur/viewer', function () { return view('landingpage.viewer'); })->name('viewer');
Route::get('/faq', function () { return view('landingpage.faq'); })->name('faq');
Route::get('/galeri', function () { return view('landingpage.galeri'); })->name('galeri');
Route::get('/kontak', function () { return view('landingpage.kontak'); })->name('kontak');
...
Route::middleware(['auth', 'auto.logout'])->group(function () {
    ...
    Route::middleware(['role:gudang'])->group(function () {
        ...
        // --- ROUTE AJAX BARU UNTUK MASTER DATA ---
        Route::post('/kategori/ajax-store', [KategoriController::class, 'storeAjax'])->name('kategori.storeAjax');
        Route::post('/satuan/ajax-store', [SatuanController::class, 'storeAjax'])->name('satuan.storeAjax');
        Route::post('/pemasok/ajax-store', [PemasokController::class, 'storeAjax'])->name('pemasok.storeAjax');
        Route::post('/lokasi/ajax-store', [LokasiController::class, 'storeAjax'])->name('lokasi.storeAjax');
        Route::post('/kondisi/ajax-store', [KondisiController::class, 'storeAjax'])->name('kondisi.storeAjax');
